...
/*
 Changements pour le passage de SDL � SDL2 (https://jeux.developpez.com/tutoriels/sdl-2/guide-migration/*):
			- SDL_HWSURFACE semble ne plus exister (utiliser SDL_SWSURFACE � la place)
			...
			- pause.c: SDL_Flip() 
			- Passer de SDL_Surface � SDL_Texture
*/
...
-b: binarisation (seuillage paramétrable)
-i: inversion (négatif)
-n: transformation en niveaux de gris (noir et blanc)
-q: quantification (avec nb de bits paramétrable)
*/
